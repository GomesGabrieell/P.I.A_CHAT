...
<section>
  <div class="corpo">
    <div class="input-group">
      ...
      <input type="text" aria-label="First name" class="form-control" placeholder="<?php echo$user_name;?>" disabled="">
    </div>
    <div class="input-group">
      <span class="input-group-text">Email</span>
      <input type="text" aria-label="First name" class="form-control" placeholder="<?php echo$email;?>" disabled="">
    </div>
    <div class="input-group">
      <span class="input-group-text">Senha</span>
      <input type="password" aria-label="First name" class="form-control" value="<?php echo$senha;?>" disabled="">
    </div>
    <div class="input-group">
    <a href="perfil_edit.php?identificacao=<?php echo$identificacao;?>&chave=<?php echo$chave?>" title="EDITAR">
